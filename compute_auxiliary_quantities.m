function [Gross_Economic_Output, E_Industrial, Net_Output,...
    Per_Cap_Consumption, Damages_Fraction, ...
...
for i=1:N
    ...
    Consumption(i) = (1-s(i)) * Net_Output(i);
    Marg_Cost_Abatement(i) = pb * ((1-deltaPB)^(i-1)) * (mu(i)^(theta2-1));
end