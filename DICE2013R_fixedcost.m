...
x_UB = [2*ones(1,N+1);inf*ones((nx-1), N+1)]; % 2 degree upper bound
...
% loop over dynamics 
Params.theta1 = ones(N+1,1).*theta;
...
%% Work out total costs expended on abatement